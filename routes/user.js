...
const hourRaffle_controller=require("../controllers/hourRaffle");
const dayRaffle_controller=require("../controllers/dayRaffle");
const weekRaffle_controller=require("../controllers/weekRaffle");
...
router.get("/complaints-admin/:status/:page", checkAuth, checkAdmin, checkSuperAdmin, complaints_controller.getComplaintsAdmin);
router.post("/complaints-admin", checkAuth,checkAdmin, checkSuperAdmin,complaints_controller.postComplaintsAdmin);
...
//reward
router.post("/reward", checkAuth, checkAdmin, checkSuperAdmin, reward_controller.createReward);
router.get("/rewards/:page", checkAuth, checkAdmin, checkSuperAdmin, reward_controller.listReward);
router.delete("/reward/:id", checkAuth, checkAdmin, checkSuperAdmin, reward_controller.deleteReward);
...
//admin raffles
router.get("/admin/raffles", checkAuth, checkAdmin, checkSuperAdmin, admin_controller.getRaffles);

//hourly raffle
router.get("/raffle/hourly", checkAuth,hourRaffle_controller.getRaffle);
router.post("/raffle/hourly", checkAuth,hourRaffle_controller.postRaffle);

//daily raffle
router.get("/raffle/daily", checkAuth,dayRaffle_controller.getRaffle);
router.post("/raffle/daily", checkAuth,dayRaffle_controller.postRaffle);

//weekly raffle
router.get("/raffle/weekly", checkAuth,weekRaffle_controller.getRaffle);
router.post("/raffle/weekly", checkAuth,weekRaffle_controller.postRaffle);

//records
router.get("/my-records/:game/:page", checkAuth, user_controller.getRecords);

//reviews
router.post("/review", checkAuth,admin_controller.postReview);
//Game Records
router.get("/game-records/:page/:game?", checkAuth, admin_controller.getRecords);
