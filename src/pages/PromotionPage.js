...
const PromotionPage = (props) => {
  ...
  const copyLink = () => {
    ...
    tmp_tag.value = `https://www.thetitanclubs.com/signup/${bonus.ref_code}`;
  ...
  return (
    ...
    >
      ...
      <Row>
        ...
        <Col md={12} className={'mt-4 ml-3 mr-3'} >
          My Promotion Link
          <span style={{ float: 'right', textDecoration: 'underline', color: "#6a82fb" }} className={'mr-5'}> https://www.thetitanclubs.com/signup/{bonus.ref_code} </span>
        </Col>
        <Col md={12} style={{ textAlign: 'center' }} className={'mt-3'}>
